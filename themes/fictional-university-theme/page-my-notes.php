	...
	while(have_posts()) {
		...
		<div class="container container--narrow page-section">
			<div class="create-note">
				...
				<span class="note-limit-message">Note limit reached: delete an existing note to make room for a
					new one.</span>
			</div>
	                ...
	                while ( $userNotes->have_posts() ) {
                        ...
                        <li data-id="<?php the_ID(); ?>">
                            ...
                            <textarea readonly class="note-body-field"><?php echo esc_textarea(get_the_content())
                                ?></textarea>
                            <span class="update-note btn btn--blue"><i class="fa fa-arrow-right"></i> Save</span>
                        </li>
	                <?php }
                ?>
            </ul>
